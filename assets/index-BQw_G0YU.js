...
aut aut aut maxime quia temporibus ut omnis`}],Pc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Lc=({user:e})=>F.jsxs("p",{children:[" Posted by  ",e&&F.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name})]}),Tc=({comment:e})=>F.jsxs("div",{className:"CommentInfo",children:[F.jsxs("div",{className:"CommentInfo__title",children:[F.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",F.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),F.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Mc=({comments:e})=>!e||!e.length?F.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"}):F.jsx("div",{className:"CommentList",children:e.map(t=>F.jsx(Tc,{comment:t},t.id))}),Rc=({post:e})=>F.jsxs("div",{className:"PostInfo",children:[F.jsxs("div",{className:"PostInfo__header",children:[F.jsx("h3",{className:"PostInfo__title",children:e.title}),F.jsx(Lc,{user:e.user})]}),F.jsx("p",{className:"PostInfo__body",children:e.body}),F.jsx("hr",{}),F.jsx(Mc,{comments:e.comments})]}),Dc=({posts:e})=>F.jsx("div",{className:"PostList",children:e.map(t=>F.jsx(Rc,{post:t},t.id))});function Ur(e){return Pc.find(t=>t.id===e)??null}const jc=zc.map(e=>({...e,user:Ur(e.userId),comments:Nc.filter(t=>t.postId===e.id).map(t=>({...t,user:Ur(t.userId)}))})),Oc=()=>F.jsxs("section",{className:"App",children:[F.jsx("h1",{className:"App__title",children:"Static list of posts"}),F.jsx(Dc,{posts:jc})]});tm(document.getElementById("root")).render(F.jsx(Oc,{}));
